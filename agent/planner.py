...
PLANNER_PROMPT = """You are the planning module of ANSH, a personal AI assistant.
...
create_presentation
  ...
  three_d_mode: "ask" | "yes" | "no" (optional; omit or ask initially so preference can be confirmed)
